...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(292, 754)
        Form.setMinimumSize(QtCore.QSize(292, 754))
        Form.setMaximumSize(QtCore.QSize(292, 754))
        ...
        self.statusComboBox = QtWidgets.QComboBox(self.verticalLayoutWidget)
...
"QTabBar::tab{height:25}")
    ...
    def retranslateUi(self, Form):
        ...
        self.statusComboBox.setItemText(0, _translate("Form", "我在线上"))
        self.statusComboBox.setItemText(1, _translate("Form", "忙碌中"))
        self.statusComboBox.setItemText(2, _translate("Form", "隐身"))
        self.statusComboBox.setItemText(3, _translate("Form", "离开"))
